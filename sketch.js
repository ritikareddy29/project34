...
function setup() {
  ...
  board1 = new Board(width - 200, 300, 50, 200);
  board2 = new Board(width - 400, height - 200, 50, 200);
  board3 = new Board(width - 500, height - 300, 50, 200);
}
...
function draw() {
  ...
  for (var i = 0; i < playerArrows.length; i++) {
    if (playerArrows[i] !== undefined) {
      ...
      if (board1Collision.collided || board2Collision.collided || board3Collision.collided) {
        score += 1;
      }
